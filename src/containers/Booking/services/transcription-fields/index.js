...
export default function Transcription({ type, register, errors, fileUploadHandler, formatWatch }) {
        ...
        <div className='mt-3'>
          ...
          <div className="form-group row">
            <div className="form-group mt-3 mx-3">
              <FileUploads fileUploadHandler={fileUploadHandler} description="upload mp3, mp4, others"/>
            </div>
          </div>
