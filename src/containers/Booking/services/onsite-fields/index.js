...
const places = [
  ...
  { name: "Detention centre", value: "Detention centre" },
  { name: "Prison centre", value: "Prison Centre" },
  { name: "Ukba Offices", value: "UKBA Offices" },
        ...
        <div className="form-group row">
          <div className="col-md-12 mt-md-0 mt-3">
            <Input
              ...
              register={register}
              required={{
                required: "Other reference is required",
              }}
              error={errors?.otherReference?.message}
            />
            <small className="form-text text-muted">
              (Court Case Ref/ Other relevant information)
            </small>
          </div>
        </div>
          ...
          <div className="col-md-12">
            ...
            <textarea
              ...
              className={
                ...
                (!errors?.placeOfAttendance ? "" : " is-invalid")
              }
              {...register("placeOfAttendance", {
